...
<?
	...
	if($result && mysql_num_rows($result)>0 ){
		...
		while($row=mysql_fetch_assoc($result)){
			...
			$returnMsg = $returnMsg . "<tr class='infobulle' name='infobulle'>";
...
<img class=\"ImgAction\" onclick=\"\" src=\"images/recherche.png\" title=\"Rechercher qui peut vous pr&ecirc;ter ce livre\" width=\"20px\" height=\"19px\" /></a>
			...
			$returnMsg = $returnMsg .  "<td style=\"text-align:center;\"><input name=\"".$idbook."Possede\" type=\"checkbox\" title=\"je l'ai\" onclick=\"return false;\" ";
			if($possede=="1") $returnMsg = $returnMsg .  "checked";
			$returnMsg = $returnMsg .  " /></td>\n";
			
			$returnMsg = $returnMsg .  "<td style=\"text-align:center;\"><input name=\"".$idbook."Lu\" type=\"checkbox\" title=\"je l'ai lu\" onclick=\"return false;\" ";
